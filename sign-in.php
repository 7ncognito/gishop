        ...
        <div class="container sign-in-up">
          <div class="row mb-5" >
            <div class="col-md-6" >
              ...
              <p>An online GI shop that allows users to check for various GI available at the online 
                store and purchase online. The project consists of list of GI products displayed from various
                 Sates. The user may browse through these products as per categories. If the user likes 
                  ...
                  <form method="post" class="mt-5 p-3">
                   ...
                   <?php if(isset($_POST['signin'])){
                    ...
                    <a href="#" > Forget Password?</a>
                      ...
                      <a href="admin/index.php">AWelcome</a>
                  </form>
                </div>
              </div>
            </div>
