      ...
      <section class="my-5">
        ...
        <?php   
          if(isset($_GET['product_id'])){
            ...
            $pdetail_query = "SELECT * FROM gi_product WHERE pid=$p_id";
          ...
          <div class="col-md-7">
            ...
            <div class="table-responsive">
              <table class="table table-borderless mb-0">
                <tbody>
                  <tr>
                    <th class="pl-0 w-25" scope="row"><strong>From State</strong></th>
...
//                     }
      ...
      <section>
        ...
        <div class="row mt-5 mb-4">
          ...
          <!-- Grid column -->
           <?php 
               $p_query = "SELECT * FROM gi_product WHERE category LIKE '%$category%' order by title DESC LIMIT 4";
