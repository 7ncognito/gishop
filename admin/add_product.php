        ...
        <div class="col-md-9 col-lg-9">
          <form method="post" enctype="multipart/form-data">
             <?php
                    ...
                    if(!empty($title) or !empty($state) or !empty($price) or !empty($status) or !empty($category) or !empty($detail) or !empty($image)){
                     $query = "INSERT INTO gi_product(`title`, `category`, `state`, `price`, `detail`, `image`, `date`, `status`)
                      VALUES('$title',$category,'$state',$price,'$detail','$image','$date','$status')";
