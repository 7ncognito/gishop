          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-danger o-hidden h-100">
              <div class="card-body">
                ...
                <div class="mr-5">
                <?php  
                   $query = "SELECT SUm(product_amount) as 'earn' FROM customer_order WHERE order_status != 'cancelled'";
                   $run   = mysqli_query($con,$query);
                          ...
                          <?php
                            ...
                            ?> 
                             <tr>
                                ...
                                <td><a href="pending_pro.php"><button class="btn btn-primary btn-sm">Verify order</button></td>
                             </tr>   
                           <?php 
                                  }
                                }
