        ...
        <div class="col-md-9 col-lg-9">
               ...
               <div class="col-md-9">
                <div class="row">
                  ...
                  <h1 class="ml-5 display-4 font-weight-normal">View GI Tags:</h1>
                  </div>
                </div>
              <hr>
                   ...
                   <div class="col-lg-8">
                     <div class="row">
                       <div class="col-lg-6">
                        <input type="text" name="category" class="form-control" placeholder="Add Tag">
                       </div>
                    ...
                    <div class="col-lg-4">
                    <input type="submit" name="submit" class="btn btn-primary" value="Add Tag" name="category">
                       </div><br/>
