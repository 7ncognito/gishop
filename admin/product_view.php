...
<?php
        ...
        if(isset($_GET['del'])){
            $del   = $_GET['del'];
            $query = "DELETE FROM `gi_product` WHERE pid = $del";
    ...
    <div class="row">
        ...
        <div class="col-md-9">
               ...
               <div class="row">
                 ...
                 <div class="col-md-7">
                   <h2 class="display-4 ml-2 mt-4">View GI Products:</h2>
                 </div> 
                 <div class="col-md-4">
                      ...
                      <thead class="thead-light">
                        ...
                        <tbody>
                          <?php
                                       ...
                                       if(isset($status)){
                                           $pr_query = "SELECT * FROM gi_product fp INNER JOIN categories cat ON fp.category = cat.id WHERE status = '$status' order by pid";
                                       } else{
                                           $pr_query = "SELECT * FROM gi_product fp INNER JOIN categories cat ON fp.category = cat.id order by pid";
                                       }
                             ...
                             <tr>
                                ...
                                <td colspan="20" class="text-center"> 
                                 <?php 
                                   ...
                                   ?>
                                    <a title="Edit Product" href="gi_pro_edit.php?pid=<?php echo $pid;?> " class="btn btn-primary btn-sm">
