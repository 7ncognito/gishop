...
$product_amount = $row['product_amount'];    
     ...
     //product Query
      $query = "SELECT * FROM gi_product WHERE pid=$product_id";
      $run   = mysqli_query($con,$query);
      $row = mysqli_fetch_array($run);
      $title    = $row['title'];
      $price    = $row['price'];
...
$pdf->Cell(130	,5,'JNRM, Port Blair , 744101',0,0);
$pdf->Cell(25	,5,'Date',0,0);
$pdf->Cell(34	,5,$order_date,0,1);//end of line

$pdf->Cell(130	,5,'Phone +7430809922',0,0);
